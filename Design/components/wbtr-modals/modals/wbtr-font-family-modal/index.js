...
class WBTR_Font_Family_Modal extends WBTRCustomElement {
...
if (!customElements.get('wbtr-font-family-modal')) {
    customElements.define('wbtr-font-family-modal', WBTR_Font_Family_Modal);
}