...
class Wbtr_More_Settings_Popover extends WBTRCustomElement {
...
if (!customElements.get('wbtr-more-settings-popover')) {
    customElements.define('wbtr-more-settings-popover', Wbtr_More_Settings_Popover);
}