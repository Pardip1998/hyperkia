...
class WBTR_Create_Gradient_Popover extends WBTRCustomElement{	
...
if(!customElements.get('wbtr-create-gradient-popover')){
	customElements.define('wbtr-create-gradient-popover',WBTR_Create_Gradient_Popover);	
}
