...
class WBTR_Page_Management extends WBTRCustomElement{
	...
	_init(){
		this._methods._showPagesList();
	}
}

if(!customElements.get('wbtr-page-management')){
	customElements.define('wbtr-page-management',WBTR_Page_Management);	
}
