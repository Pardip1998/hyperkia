...
class WBTR_Design_Sidebar_Designs extends WBTRCustomElement{
	...
	_init(){
		this._methods._updateAvailableFonts();		
	}
}

if(!customElements.get('wbtr-design-sidebar-designs')){
	customElements.define('wbtr-design-sidebar-designs',WBTR_Design_Sidebar_Designs);	
}
