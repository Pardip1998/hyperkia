...
class WBTR_Canvas extends WBTRCustomElement{
	...
	_init(){		
		this._methods._createPages();
		this._methods._canvasContentSetup();
		this._methods._rectCalculate();
		this._methods._canvasZoomLevelOnLoad();
		this.scrollTo(0,0);
		this._props._currentTarget = this;
	}
...
if(!customElements.get('wbtr-canvas')){
	customElements.define('wbtr-canvas',WBTR_Canvas);	
}
